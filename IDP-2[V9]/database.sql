...
-- Add rating and completion tracking to work_posts
ALTER TABLE work_posts 
ADD COLUMN assigned_worker_id INT NULL AFTER employer_id,
ADD COLUMN completed_at TIMESTAMP NULL AFTER created_at,
ADD FOREIGN KEY (assigned_worker_id) REFERENCES users(id) ON DELETE SET NULL;
